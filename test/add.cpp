...
TEST(Add, reg_reg) {
    ...
    cpu.get_registers().set_register(U8, Eax, 0x10);
    cpu.get_registers().set_register(U8, Ecx, 0x01);
...
TEST(Add, mem_reg) {
    ...
    cpu.get_registers().set_register(U32, Ebx, 300);
    cpu.get_registers().set_register(U32, Edx, 0x01020304);
    cpu.execute_next_instruction();
...
TEST(Add, reg_mem_disp) {
    ...
    cpu.get_registers().set_register(U32, Esi, 300);
    cpu.get_registers().set_register(U32, Edi, 0x01020304);
    cpu.execute_next_instruction();
